							...
							<div class="Admin-dash px-4">
								<div class="col-xl-12 col-sm-12 px-0 Admin-table1">
									<div id="Ap-Table-header">
										<p>Check Fee Reciept</p>
									</div>
									<div class="col-xl-12 col-sm-12 search_course">
										<form action="" method="post">
											<input placeholder="ENTER ORDER ID" id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo $ORDER_ID ?>" style="width: 100%;height: 45px;border: 1px solid #ddd;padding-left: 16px;"><br>

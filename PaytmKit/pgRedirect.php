...
$paramList["CALLBACK_URL"] = "http://localhost/phpr/RP-PROJECT/pgResponse.php?course_id=$course_id&si=$stu_id";
/*
...
<body>
	<center><h1>Please do not refresh this page...</h1></center>
		...
		<table border="1">
			...
			<input type="text" name="stu_username" value="<?php echo($stu_username) ?>">
